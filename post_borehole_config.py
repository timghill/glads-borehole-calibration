...
sim_dir = os.path.join(base, 'issm/issm/post_borehole/')
...
X_physical = os.path.join(sim_dir, 'post_theta_phys.csv')
X_log = None
X_standard = os.path.join(sim_dir, 'post_theta_std.csv') 
table = 'train.dat'
