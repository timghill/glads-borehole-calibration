...
def main(train_config, bh_config,
    ...
    fig.savefig('figures/02_ensemble_data_timeseries_summer.png', dpi=600)
    ...
    model_file = 'data/summer_m{:03d}_p{:02d}'.format(m, p)
    ...
    figdir = 'figures/summer/m{:03d}_p{:02d}/'.format(train_config.m, train_config.p)
