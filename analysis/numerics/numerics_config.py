...
m_max = 100                         # Number of simulations
...
sim_dir = os.path.join(base, 'issm/issm/test_numerics/')
exp_dir = os.path.join(base, 'issm/expdesign/')
mesh = os.path.join(sim_dir, '../data/geom/IS_mesh.pkl')
...
def parser(md, jobid):
    ...
    # Use coarser numerical parameters
